...
if($_GET['signup']=='step1')
{
	echo "
		<h1>Nýskrá</h1>
		<form action='?part=me&AMP;signup=step2' id='signup' method='post'>
			<fieldset>
...
else
{
	...
	else if($_POST['password']!=$_POST['cpassword']) {if(!$error){echo "Skráning tókst ekki";} echo ", Lykilorð og staðfesting þess báru ekki saman"; $error=1;}
	$eml = $_POST['email']; 
	...
	{echo "<br><a href='?part=me&signup=step1'>Til baka.</a>";}			
}
?>
